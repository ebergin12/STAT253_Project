...
# data_cv10 <- imdb_clean %>% 
#     filter(No_of_Votes < 1500000 & IMDB_Rating < 9) %>% # remove outliers
#     vfold_cv(v = 10)
...
# This code chunk has an error, but I'm not sure why
