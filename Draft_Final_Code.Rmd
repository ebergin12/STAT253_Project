...
The GAM created using TidyModels performs better than the recipe and LASSO GAMs.

### Visualize Residuals for Final GAM
...
### Obtain OOB Predictions and Evaluation Metrics
